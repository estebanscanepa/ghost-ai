...
- large screens: simple two-panel layout, split 50/50
- left: sits on `bg-elevated` so the panel reads as its own surface against the near-black form side. Logo mark and wordmark at the top, headline plus supporting paragraph in the middle, three-item feature list (small brand-tinted icon, title, one-line description), copyright at the bottom
